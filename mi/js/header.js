...
//
//            if(result.uname){
//                $('#head_landing').html('<li><a href="cart.html">购物车<img src="img/cart/cart.png" alt=""/></a></li><b>|</b><li>&nbsp;欢迎:'+session.user_name+' <a href="logout.html" title="退出登录">退出</a><b>|</b></li><li><a href="uc_basic.html" title="用户中心">用户中心</a></li>');
...
//                    e.preventDefault();
//                    $.ajax({
//                        url: '127.0.0.1:3000/user/logout',
//                        success: function(result){
//                            if(result.code===200){
